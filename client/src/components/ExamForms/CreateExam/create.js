...
const accord = (classes,expanded,handleChange) => {
  ...
  return (
     <Accordion expanded={expanded === 'panel1'} onChange={handleChange('panel1')}>
        ...
        >
          ...
          <Typography className={classes.secondaryHeading}>Multiple Choice</Typography>
        </AccordionSummary>
        <AccordionDetails>
          <Typography>
...
function CreateExam() {
    ...
    return (
      ...
      <div className={classes.acc}>
            {accord(classes,expanded,handleChange)}  
    </div>
