...
function CreateExam() {
  ...
  const Sample = (e) => {
    // alert(e.id)
    const dynamicItems = (<a>Sample</a>)
   
    console.table(dynamicParts)
   ...
   if(partNum <= 10) {
    ...
    const newDynamicElem = (
        <>
          ...
          <Accordion defaultExpanded={true} key={partNum+"accordion"}>
            <AccordionSummary
              expandIcon={<ExpandMoreIcon />}
          ...
          > 
                                ...
                                <Autocomplete
                                  ...
                                  renderInput={(params) => (
                                    <TextField
                                      ...
                                      name={partNum.toString()+"examTypes"}
                                      type="text"
                                      inputRef={register}
                                      variant="outlined"
                                    />
                  ...
                  <Box p={0} m={1} css={{ width: 200 }} flexGrow={1}>
                      <TextField
                        ...
                        type="number"
                        name= {partNum.toString()+"partNoOfItems"}
                        variant="outlined"
                        fullWidth
                        inputRef={register}
                      />
                ...
                <Box p={0} m={1} css={{ width: 200 }} flexGrow={1}>
                      <TextField
                        ...
                        type="number"
                        name={partNum.toString()+"partPointsPerItem"}
                        variant="outlined"
                        fullWidth
                        inputRef={register}
                      />
                ...
                <Box p={0} m={1} css={{ width: 200 }} flexGrow={1}>
                                <Autocomplete
                                  ...
                                  renderInput={(params) => (
                                    <TextField
                                      ...
                                      {...params}
                                      label="difficulty"
                                      name={partNum.toString()+"difficulty"}
                                      type="text"
                                      inputRef={register}
                                      variant="outlined"
                                    />
                  ...
                  <Box p={0} m={1} css={{ width: 400 }} flexGrow={1}>
                      <TextField
                        ...
                        type="number"
                        name={partNum.toString()+"partSetInstructions"}
                        variant="outlined"
                        multiline
                        fullWidth
                        inputRef={register}
                  ...
                  <div style={{ width: "100%" }} key={partNum+"div1"}>
                  <Button
                  name= "btnn"
                    variant="contained"
                    color="default"
                    startIcon={<AddIcon />}
                    id={partNum}
                    onClick={(e) => Sample(e.currentTarget)}
                  >
                    Sample
                  </Button>
                  </div>
                 
                  <div style={{ width: "100%" }} key={partNum+"div2"}></div>
                  </Box>
            </AccordionDetails>
          </Accordion>
        </>
    ...
    <>
     ...
     <Container>
      ...
      alignContent="flex-start">
        ...
        onClick={() =>(
          addElement(),
          console.log(dynamicParts.slice())
        )
