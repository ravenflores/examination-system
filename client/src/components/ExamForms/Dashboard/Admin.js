    ...
    const drawer = (
      ...
      <Collapse in={open} timeout="auto" unmountOnExit>
        <List component="div" disablePadding>
          <ListItem button onClick={()=>(setMobileOpen(false),setOnPage(<ClassList />))} className={classes.nested}>
            <ListItemText primary="Class List" />
          </ListItem>
          <ListItem button onClick={()=>(setMobileOpen(false),setOnPage(<CreateClass />))} className={classes.nested}>
